...
public class ProductController {
    ...
    public String getProductTable(Model model, @RequestParam("page") Optional<String> pageOptional) {
        int page = 1;
        try {
        ...
        Page<Product> pageProduct = this.productService.fetchProducts(pageable);
