                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group quantity mb-3" style="width: 100px;">
                                                <div class="input-group-btn">
                                                    <button
                                                        class="btn btn-sm btn-minus rounded-circle bg-light border quantity-control">
                                                ...
                                                <div class="input-group-btn">
                                                    <button
                                                        class="btn btn-sm btn-plus rounded-circle bg-light border quantity-control">
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <form:form action="/add-multi-product-to-cart" method="post"
                                                ...
                                                <form:input type="hidden"
                                                    class="form-control form-control-sm text-center border-0 detail-quantity"
                                                    value="2" path="quantity" />
                                                <!--  -->
                                                <button
